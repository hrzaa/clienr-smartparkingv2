...
const ParkingDetection1 = () => {
  ...
  return (
    <>
      {parkingData.length ? (
        <div className="bg-zinc-800 text-zinc-300 w-full min-h-screen p-5">
            ...
            {!loading &&
              parkingData.map((data, i) => {
                return (
                  <div
                    key={data.id}
                    className="bg-zinc-700 p-5 shadow-lg rounded"
                  >
                    <h1 className="text-center pb-5 font-semibold text-xl lg:text-2xl">
                      {data.parking_name}
                    </h1>
        ...
        <div className="bg-zinc-800 text-zinc-300 flex justify-center items-center w-full h-screen">
